export const IPC_EVENT = {
  ...
  sessionReaderSettings: 'sessionReaderSettings',
  sessionReaderConfigure: 'sessionReaderConfigure',
  sessionReaderRequest: 'sessionReaderRequest',
  ...
  focusCaptureSource: 'focusCaptureSource',
